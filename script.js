$(document).ready(function() {
	...
	const datatableRowTemplate = $('[data-datatable-rowtemplate]').children()[0];
...
function handleBoardNameSelect(event) {
	...
	var $listNameSelectEl = $changedSelectEl.siblings('[data-list-nameselect]');
...
function handleCardCreationRequest(event) {
	...
	var selectedListId = $relatedTaskRow.find('[data-list-nameselect]').val();
